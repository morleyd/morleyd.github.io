...
const projects: Project[] = [
  {
    ...
    popupContent: `
      ...
      <p><a href="https://github.com/morleyd/morleyd.github.io/blob/master/public/Projects/Relation_Extraction_without_Given_Spans.ipynb">Click Here for a notebook with my completed code and or go to Google Colab to try it for yourself.</a></p>
    `,
  },
  {
    id: 'wordle',
